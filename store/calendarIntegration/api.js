...
function calendarintegration_delete_users_me_calendarList_calender_id_delete(payload) {
  return calendarIntegration.delete(`/users/me/calendarList/${payload.calender_id}`);
}
